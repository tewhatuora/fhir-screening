// Instance: SearchResponse-OneMatchOneIssue
// InstanceOf: Bundle
// Usage: #example
// Description: "Example of screening summary search response when there is a match AND an issue to display"

// * meta.versionId = "1"
// * meta.lastUpdated = "2024-05-28T06:26:00Z"

// * id = "ResponseBundleExample-OneMatchOneIssue"
// * type = #searchset
// * total = 2   // one screening summary and 1 issue
...
// * entry[=].resource insert SearchInformationalOperationOutcome(2,[[Please check with the National Screening Unit about the registration status for this person]])
